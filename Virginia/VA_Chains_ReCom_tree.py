...
tree_proposal = partial(
    recom, pop_col="TAPERSONS", pop_target=ideal_population, epsilon=0.006, node_repeats=1, method = my_uu_bipartition_tree_random)#bipartition_tree_random
#)
